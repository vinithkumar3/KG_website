...
const googleReviewUrl = "https://www.google.com/search?q=KG%20batminton%20court&ludocid=16668555629921522522&ibp=gwp;0,7&sa=X&ved=2ahUKEwjsl_-L-9H_AhXTR2wGHX_6DD8Q_coHegQIDBAB&biw=360&bih=560&dpr=2";
const data = [
  {
    id: 1,
    ...
    comment:" Maintenance is very good and it is right place to spend the time 👍",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    comment:
      " Neat and well maintenace court at mangadu",
...
const ReviewLink = () => {
  ...
  return (<><section id="review" className="testimonials container section">
    ...
    <a href={googleReviewUrl} class="reviewbutton" target="_blank" rel="noopener noreferrer">
